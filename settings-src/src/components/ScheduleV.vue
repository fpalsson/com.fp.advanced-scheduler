      ...
      <v-expansion-panel-content>
        ...
        <v-expansion-panels>
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              <token-v v-for="(token) in schedule.tokens" :key="token.id" :token="token" />
          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              <schedule-item-v v-for="(si) in schedule.scheduleitems" :key="si.id" :scheduleitem="si" />
...
<script>
import TokenV from '@/components/TokenV';
import ScheduleItemV from '@/components/ScheduleItemV';
import { WebSettings, Schedule, ScheduleItem, Token, DaysType, TimeType } from '../websettings'
